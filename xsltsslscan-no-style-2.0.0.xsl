...
09/14/2021 - Bare table format for rich text reporting tools
...
<!--Begin Full Results Table-->
  ...
  <table>
    ...
    <tr>
      <td>Target</td>
      <td>Server Protocols</td>
      <td>Server Checks</td>
      <td>Accepted Ciphers</td>
      <td>Key Exchange Groups</td>
      <td>Server Signature Algorithms</td>
      <td>Certificate Checks</td>
    </tr>
    <!--Per-SSLScan Result Row Template-->
    <xsl:for-each select="document/ssltest">
    <xsl:sort select="./@host" order="ascending"/>
